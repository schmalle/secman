...
**Feature Branch**: `001-ai-norm-mapping`
**Created**: 2026-01-02
**Status**: Draft
...
3. **Existing Norms Database**: The system already has ISO 27001 and IEC 62443 norms stored in the database that can be matched with AI suggestions
4. **User Permissions**: Users with access to the Requirements Management page have permission to add norm mappings
