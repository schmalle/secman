...
**Independent Test**: Upload a CSV mapping file to S3, run `./scriptpp/secman manage-user-mappings import-s3 --bucket <bucket> --key <key> --admin-user admin@example.com`, verify mappings appear in database
