-- Manual Fix: Create asset_deletion_audit_log table
-- Feature: 033-cascade-asset-deletion
-- Date: 2025-10-25
-- Purpose: Fix missing audit log table that prevents asset deletion

-- Execute this script in your MariaDB database to fix the deletion issue
...
COMMENT = 'Immutable audit trail for asset cascade deletions (Feature 033)';

-- Verify the table was created
SELECT 'Table created successfully' AS status, COUNT(*) as initial_count
FROM asset_deletion_audit_log;
