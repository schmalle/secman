...
> **Sync policy (two-way, mandatory)**: This file and `.claude/skills/admin-
> asset-e2e/SKILL.md` are one skill kept in two harness trees — Codex reads
> this copy, Claude Code reads the other. Whichever copy an agent edits, the
> same change is ported to the other **in the same commit**; translate
