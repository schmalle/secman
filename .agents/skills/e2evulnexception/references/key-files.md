...
> `.claude/skills/e2evulnexception/references/key-files.md` are one skill kept
> in two harness trees — Codex reads this copy, Claude Code reads the other.
...
> verbatim (e.g. `sandbox_permissions: "require_escalated"` ↔ Bash tool
