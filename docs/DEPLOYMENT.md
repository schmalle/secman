...
Linux production. Backend (`:8080`) + Frontend (`:4321`) behind nginx with SSL termination, MariaDB on `:3306`. Stack: Kotlin 2.4.10/Java 25/Micronaut 5.1 + Astro 7.2/React 19/Node 20 + MariaDB 11.4. Tested on Amazon Linux 2023, Ubuntu 20.04+, RHEL 8+.
...
# Ubuntu / Debian
sudo apt install -y openjdk-25-jdk git build-essential nginx
