...
import type { AssetInterventionStatus } from './accountVulnsService';
...
export interface AssetVulnCount {
  ...
  // Exception + intervention status. Absent from this view until AssetVulnCountsQuery replaced
  // its private copy of the counting query, which could not carry the exception columns.
