...
export default function IntegrationScannerConfig({ scanner, onSaved }: { scanner?: Scanner; onSaved: () => void }) {
  ...
  return <section className="card mb-3"><div className="card-body">
    ...
    <form onSubmit={submit} className="row g-3">
      ...
      <div className="col-md-3"><label className="form-label">Source<select className="form-select" value={source} disabled={!!scanner} onChange={e => setSource(e.target.value)}><option value="VISUAL">Visual scanner</option><option value="WEB_SECURITY">Web security scanner</option><option value="GITHUB_AI">GitHub AI</option></select></label></div>
