...
const AccountVulnsView: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Admins are no longer skipped: the intervention indicator only helps if the people who
        // act on it can see it, and System Vulnerabilities has no asset-grouped overview. The
        // backend bounds the response and returns a clear error if the estate is too large.
        fetchAccountVulns();
    }, []);
