...
class AddWorkgroupAdDomainTool(
    ...
    override val description = "Add an AD domain to a workgroup (ADMIN/SECCHAMPION, requires User Delegation)"
    ...
    override suspend fun execute(arguments: Map<String, Any>, context: McpExecutionContext): McpToolResult {
        ...
        if (!context.canManageGrants) {
            return McpToolResult.error("ADMIN_REQUIRED", "ADMIN or SECCHAMPION role required to add AD domains to a workgroup")
        }
