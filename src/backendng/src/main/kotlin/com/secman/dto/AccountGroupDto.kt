 ...
 * @property assetsNeedingAttention Count of assets in this account whose status is not GREEN
 * @property status Worst asset status in this account: one RED asset makes the account RED
 */
@Serdeable
data class AccountGroupDto(
    ...
    // Worst intervention status across this account's assets (nullable for backward compatibility)
    val assetsNeedingAttention: Int? = null,
