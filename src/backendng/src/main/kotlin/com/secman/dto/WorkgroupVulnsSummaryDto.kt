...
data class WorkgroupVulnsSummaryDto(
    ...
    // Exception + intervention roll-up. Computed over assets deduplicated by id, because an
    // asset may belong to several workgroups and would otherwise be counted more than once.
