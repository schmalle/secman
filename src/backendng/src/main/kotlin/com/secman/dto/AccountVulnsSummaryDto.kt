...
data class AccountVulnsSummaryDto(
    ...
    // Intervention status roll-up (nullable for backward compatibility). thresholdDays is echoed
    // so the UI can render "older than N days" from data instead of hardcoding the number.
    val globalStatus: AssetInterventionStatus? = null,
