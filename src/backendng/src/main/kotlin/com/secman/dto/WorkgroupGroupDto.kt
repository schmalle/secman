...
data class WorkgroupGroupDto(
    ...
    // Exception aggregation. Absent until AssetVulnCountsQuery replaced this view's private copy
    // of the counting query, which omitted the asset JOIN that ExceptionMatchSql requires.
    val totalExcepted: Int? = null,
    val totalNonExcepted: Int? = null,

    // Worst intervention status across this workgroup's assets
