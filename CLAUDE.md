...
- Frontend: `src/frontend/` - Astro + React islands, Axios, JWT in HttpOnly cookies
...
4. Schema Evolution: Flyway migrations + Hibernate validation
...
- Frontend: JWT in HttpOnly cookie (`secman_auth`), user data in localStorage (`user`)
