...
- E2E tests (run manually): `cd tests/e2e && SECMAN_BACKEND_URL=http://localhost:4321 SECMAN_ADMIN_NAME=... SECMAN_ADMIN_PASS=... SECMAN_USER_USER=... SECMAN_USER_PASS=... npx playwright test`
