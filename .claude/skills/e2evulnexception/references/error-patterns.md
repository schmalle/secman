...
> `.agents/skills/e2evulnexception/references/error-patterns.md` are one skill
> kept in two harness trees — Claude Code reads this copy, Codex reads the
...
> copying verbatim (e.g. Bash tool `dangerouslyDisableSandbox: true` ↔
