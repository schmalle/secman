...
> `.agents/skills/optimizer/SKILL.md` are one skill kept in two harness trees
...
`.claude/skills/humanizer/references/rename-hazards.md` before extracting
...
Bash tool `dangerouslyDisableSandbox: true`), then stop it. A query change that
